...
namespace crg::renderer {
    bool ModelLoader::loadObjFile(const std::filesystem::path& path, std::vector<VertexAttributes>& vertexData) {
    ...
    wgpu::Texture ModelLoader::loadTexture(
